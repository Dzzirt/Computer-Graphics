package com.ispring.nikitakuzin.somegame.Utils;
/**
...
public class ShaderUtils {
    ...
    public static int createShader(Context context, int type, int shaderRaw) {
        String shaderText = FileUtils.readTextFromRaw(context, shaderRaw);
